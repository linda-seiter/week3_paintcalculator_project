...
//        Method method = Class.forName("PaintCalculator").getMethod("wallArea",double.class, double.class, double.class);
//        assertEquals(540.0, method.invoke(null, 12.0, 15.0, 10.0));
//    }
//
//    @Test
